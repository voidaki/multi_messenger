...
from coincidence_sig_v2 import TS, p_value, test_statistic
from skymap import *
...
neutrino_list = [IceCubeNeutrino(nu_mjd, 210.20, 20.74, 1.84, 10**3.4)]
grace_id = 'S241106ba'
...
test_stat = test_statistic(tgw, gw_skymap, far, neutrino_list, single_neutrino=True)
...
neutrino_list = [IceCubeNeutrino(nu_mjd1, 235.45, -42.76, 0.43, 10**3.9), 
                 IceCubeNeutrino(nu_mjd2, 87.36, -1.75, 2.45, 10**2.9)]
...
neutrino_list = [IceCubeNeutrino(nu_mjd, 246.14, 64.44, 1.88, 10**2.9)]
...
neutrino_list = [IceCubeNeutrino(nu_mjd, 338.77, 42.96, 1.48, 10**2.8)]
...
neutrino_list = [IceCubeNeutrino(nu_mjd, 220.38, 26.40, 0.86, 10**2.5)]
